...
echo $T.$T."<script type=\"text/javascript\" src=\"/".SFB_PATH."jquery.sfbrowser.js".$sCache."\"></script>".$N;
...
foreach ($aPlugins as $sPlugin) {
	...
	$asPpth = '/'.SFB_PATH."plugins/".$sPlugin;
	...
	if ($bInit) {
		...
		$asPlang = $asPpth."/lang/".SFB_LANG.".js";
		if (file_exists($sPlang)) echo $T.$T."<script type=\"text/javascript\" src=\"".$asPlang."\"></script>".$N;
		// js
		$sPlug = $sPpth."/jquery.sfbrowser.".$sPlugin.$sMin.".js";
		$asPlug = $asPpth."/jquery.sfbrowser.".$sPlugin.$sMin.".js";
		if (file_exists($sPlug)) echo $T.$T."<script type=\"text/javascript\" src=\"".$asPlug."\"></script>".$N;
		// css
		$sCsss = $sPpth."/css/screen".$sMin.".css";
		$asCsss = $asPpth."/css/screen".$sMin.".css";
		if (file_exists($sCsss)) echo $T.$T."<link rel=\"stylesheet\" type=\"text/css\" media=\"screen\" href=\"".$asCsss."\" />".$N;
		// html
