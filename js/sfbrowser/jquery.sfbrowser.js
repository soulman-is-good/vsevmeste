...
//	var rFileNameWiExt = /(.*)[\/\\]([^\/\\]+\.\w+)$/;
	...
	$.sfbrowser = {
		...
		,defaults: {
			...
			,img:		["gif","jpg","jpeg","png","JPG","GIF","JPEG","PNG"]
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function keyDown(e) {
		...
		switch (e.keyCode) {
			case 13: if(bRenaming) {bTrDownHasRenamed = renameTryToPost()!==false; }
                            else if (bIsOpen) chooseFile(); break; //$$ disable in pluginmode
		}
