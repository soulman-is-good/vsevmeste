 ...
 * @author Soul_man
 */
class Report_Stat extends X3_Module_Table {

    public $encoding = 'UTF-8';
    /*
     * uncomment if want new model functional
     */
    public $tableName = 'user_report_stat';

    public $_fields = array(
        'id'=>array('integer[10]','unsigned','primary','auto_increment'),
        'report_id'=>array('integer[10]','unsigned','index','ref'=>array('Warning','id','default'=>"title")),
